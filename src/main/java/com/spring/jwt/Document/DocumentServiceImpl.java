...
public class DocumentServiceImpl implements DocumentService {
    ...
    @Override
    @Transactional
    public DocumentResponseDTO uploadDocument(Integer userId, MultipartFile file,
    ...
    @Override
    public DocumentDetailResponseDTO getDocumentById(Integer userId, Integer documentId)
    {
    ...
    @Override
    public DocumentDetailResponseDTO getDocumentByType(Integer userId, DocumentType documentType)
    {
    ...
    @Override
    public List<DocumentResponseDTO> getAllDocumentsByUserId(Integer userId)
    {
    ...
    @Override
    public List<DocumentResponseDTO> getDocumentsByTypes(Integer userId, List<DocumentType> documentTypes)
    {
    ...
    @Override
    public DocumentResponseDTO updateDocument(Integer userId, Integer documentId, MultipartFile file,
            String description)
    {
    ...
    @Override
    public void deleteDocumentByType(Integer userId, DocumentType documentType)
    {
    ...
    @Override
    public boolean documentExists(Integer userId, DocumentType documentType)
    {
        return documentRepository.existsByUserIdAndDocumentType(userId, documentType);
    }

    @Override
    public long getDocumentCount(Integer userId)
    {
        return documentRepository.countByUserId(userId);
    }

    @Override
    public Optional<DocumentMetadata> getDocumentMetadata(Integer userId, Integer documentId)
    {
